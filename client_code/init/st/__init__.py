    ...
    for j in range (2,rows+2): # rows
      for i in range (1,12):
        ...
        if i == 3:
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=2, width_xs=1)
          #self.txb[k].set_event_handler('lost_focus', self.ll_focus) 
        if i == 4:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=3, width_xs=1)
          #self.txb[k].set_event_handler('lost_focus', self.ll_focus) 
        if i == 5:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=4, width_xs=1)
          #self.txb[k].set_event_handler('lost_focus', self.ll_focus)                          
        if i == 6:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=5, width_xs=1)                                            
        if i == 7:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
                              spacing_above = "small",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=6, width_xs=1) 
        if i == 8:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
                              spacing_above = "small",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=7, width_xs=1)                          
        if i == 9:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
                              spacing_above = "small",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=8, width_xs=1)                          
        if i == 10:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
                              spacing_above = "small",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=9, width_xs=1) 
        ...
        if i == 11:
          ...
          self.txb[k].text = "X"
          self.txb[k].role = "raised"                     
          self.grid_panel_6.add_component(self.txb[k], row=j, col_xs=10, width_xs=1)
    ...
    for j in range (2,rows+2): # rows
      for i in range (1,11):
        ...
        if i == 2:
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=1, width_xs=1)
          #self.txb[k].set_event_handler('lost_focus', self.ll_focus)                        
        if i == 3:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=2, width_xs=1)
          #self.txb[k].set_event_handler('lost_focus', self.ll_focus) 
        if i == 4:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=3, width_xs=1)
          #self.txb[k].set_event_handler('lost_focus', self.ll_focus) 
        if i == 5:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=4, width_xs=1)
          #self.txb[k].set_event_handler('lost_focus', self.ll_focus)                          
        if i == 6:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=5, width_xs=1)                                            
        if i == 7:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
                              spacing_above = "small",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=6, width_xs=1) 
        if i == 8:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
                              spacing_above = "small",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=7, width_xs=1)                          
        if i == 9:
          k=500+j*10+i        
          self.txb[k] = TextArea(font="Arial", font_size="10",
                              spacing_above = "small",
          ...
          self.txb[k].role = "scroll"
          self.txb[k].tag.name = k                           
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=8, width_xs=1)                        
        ...
        if i == 10:
          ...
          self.txb[k].text = "X"
          self.txb[k].role = "raised"                     
          self.grid_panel_7.add_component(self.txb[k], row=j, col_xs=9, width_xs=1)
